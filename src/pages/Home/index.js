  ...
  return (
    <ThemeProvider theme={theme} >
        ...
        <Paper elevation={0} sx={{
                ...
                {/* page 1 */}
            <Paper elevation={0} className='home1' sx={{
                height: "90vh",
                width: "90vw",
                margin: "0 auto",
                marginTop: "3vh",
                ...
                <Grid container spacing={2}>
                    ...
                    <Item sx={{boxShadow: "none", backgroundColor: "#f9f9f9"}}>
                        ...
                        <Typography variant='h6' sx={{fontSize: "1rem", ml: 4, mr: 4, textAlign: "left"}}>
                        The greenest campus of India, home to the smartest engineers of the country. Among top 200 greenest colleges of India
                        </Typography>
                        <Link sx={{backgroundImage: "linear-gradient(to right, #ADBB31, #456D4E)", color: "#fff", borderRadius: "4rem", p: 1.5, pl: 4, pr: 4, letterSpacing: '1px', display: "inline-block", m: 4, fontSize: "1rem"}} underline="none">
                            Let's get started
                        </Link>
                    </Item>
                    </Grid>
            ...
            {/* page 2 */}
            <Paper elevation={0} className='home2' sx={{
                height: "90vh",
                width: "90vw",
                margin: "0 auto",
                marginTop: "3vh",
                ...
                <Grid container spacing={2}>
                    ...
                    <Item sx={{boxShadow: "none", backgroundColor: "#f9f9f9"}}>
                        ...
                        <Typography variant='h6' sx={{fontSize: "1rem", ml: 4, mr: 4, mt: 3, textAlign: "left"}}>
                        The solution focuses on reducing the net carbon emission to zero in the campus using incentives and technology...
                        </Typography>
                        <Typography variant='h6' sx={{fontSize: "1rem", ml: 4, mr: 4, mt: 3, textAlign: "left"}}>
                        ...
                        <br />
                        Blockchain-based Green Coins and an NFT for planting activities
                        </Typography>
                    </Item>
                    </Grid>
                </Grid>
